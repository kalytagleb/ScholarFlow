...
public final class MajorRevisionState implements PaperState {
    private final Paper paper;
    private final PaperState except;

    public MajorRevisionState(final Paper paper) {
        this.paper = Objects.requireNonNull(paper);
        this.except = new ExceptState(PaperStatus.MAJOR_REVISION);
    }

    @Override
    public PaperStatus status() {
        return PaperStatus.MAJOR_REVISION;
    }
